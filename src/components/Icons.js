...
/**
 * Collection d'icônes SVG pour l'application
 * Chaque composant accepte une prop className pour le style
 */
...
export const RefreshIcon = ({ className }) => (
  ...
  >
    <path d="M23 4V10H17" />
    <path d="M1 20V14H7" />
    <path d="M3.51 9.00001C4.01717 7.56586 4.87913 6.2899 6.01547 5.27495C7.1518 4.26 8.52547 3.54233 10.0083 3.1851C11.4911 2.82788 13.0348 2.84181 14.5091 3.22531C15.9834 3.6088 17.3421 4.34536 18.456 5.38801L23 10M1 14L5.544 18.612C6.65794 19.6547 8.01658 20.3912 9.49087 20.7747C10.9652 21.1582 12.5089 21.1721 13.9917 20.8149C15.4745 20.4577 16.8482 19.74 17.9845 18.7251C19.1209 17.7101 19.9828 16.4342 20.49 15" />
  </svg>
);
